Feature: Improved category filtering for clothing items displayed on a product page
  ...
  Scenario: more scenarios for Closing each of the lightboxes above?

  Scenario: Select 'THE ORDERING OF' the category filters on Men's shirts product page ---- Is this possible? And does it affect ALL product types eg. shirts, trousers, suits etc
