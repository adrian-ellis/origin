...
Feature: Mandatory selection of clothing measurements/options
  ...
  Scenarios:
    ...
    |   DE    |  formal shirt   |     FN285WHT      |      sleeve length         |      collar size           |
  ...
  Scenarios:
    | country |  product_type   | product_item_code |  mandatory_measurement_1   |  mandatory_measurement_2   |
    |   GB    |  casual shirt   |     cz096red      |      size                  |                            |
    |   DE    |  casual shirt   |     cz096red      |      size                  |                            |
    |   GB    |  formal shirt   |     FN285WHT      |      sleeve length         |                            |
    |   DE    |  formal shirt   |     FN285WHT      |      sleeve length         |                            |
